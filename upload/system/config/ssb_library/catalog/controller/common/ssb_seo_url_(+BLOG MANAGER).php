	...
	*/
	...
	public function rewrite($link, $query_filter = '') {
		...
		foreach ($data as $key => $value) {
			...
			//blog_manager:($data['route'] == 'blog/category/home')
