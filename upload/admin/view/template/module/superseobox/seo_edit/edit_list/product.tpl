<?php 
	...
	$seo_edit_metadata = array(
		array('table' => 'product_description','col' => 'name', 'data_name' => 'name', 'type' => 'text'),
	...
	$th_name = array('Image', 'Name', 'URL', 'Tags', 'Description', 'Meta Keywords', 'Meta Descriptions', 'Title', 'SEO H1', 'Related Products');
?>
