...
<span class="colorFC580B"> After you turn on any of these buttons on your pages will be created floating or fixed panel bar, which you can customize in <a href="#seo_tool_set_panel_bar" data-toggle="tab">Setting Panel bar</a></span>
</p>
