		...
		<div id="et-content">
			<?php if (isset($haspermission_editSetting)) { ?>
				<div class="floatRight">
                    <a onclick="$('#blogSetting').submit();" class="button"><?php echo $button_save; ?></a>
                  ...
                  <?php foreach ($languages as $language) { ?>
					...
					<div id="tabCategory">
						...
						<table class="form blogSetting">
							...
							<tr>
								<td><?php echo $entry_auto_keyword; ?></td>
								<td class="select_90">
									<select name="autoCatKeyword">
										<?php if ($autoCatKeywordValue || !isset($autoCatKeywordValue)) { ?>
									...
									<?php echo $entry_auto_keyword_help; ?>
								</td>
							</tr>
							<tr>
								<td><?php echo $entry_category_robots; ?></td>
								<td class="select_175">
								   <select name="categoryRobots">
									   <option value="index, follow" <?php if($categoryRobotsValue == 'index, follow'){ echo 'selected="selected"'; } ?>><?php echo $text_index_follow; ?></option>
									   <option value="noindex, follow" <?php if($categoryRobotsValue == 'noindex, follow'){ echo 'selected="selected"'; } ?>><?php echo $text_noindex_follow; ?></option>
									   <option value="index, nofollow" <?php if($categoryRobotsValue == 'index, nofollow'){ echo 'selected="selected"'; } ?>><?php echo $text_index_nofollow; ?></option>
									   <option value="noindex, nofollow" <?php if($categoryRobotsValue == 'noindex, nofollow'){ echo 'selected="selected"'; } ?>><?php echo $text_noindex_nofollow; ?></option>
								   </select>
								   <?php echo $entry_category_robots_help; ?>
								</td>
							</tr>
							<tr>
					...
					<div id="tabArticle">
						...
						<table class="form blogSetting">
							...
							<tr>
								<td><?php echo $entry_auto_keyword; ?></td>
								<td class="select_90">
									<select name="autoArtKeyword">
										<?php if ($autoArtKeywordValue || !isset($autoArtKeywordValue)) { ?>
											<option value="1" selected="selected"><?php echo $text_enabled; ?></option>
											<option value="0"><?php echo $text_disabled; ?></option>
										<?php } else { ?>
											<option value="1"><?php echo $text_enabled; ?></option>
							...
							<tr>
								<td><?php echo $entry_article_robots; ?></td>
								<td class="select_175">
									<select name="articleRobots">
										<option value="index, follow" <?php if($articleRobotsValue == 'index, follow'){ echo 'selected="selected"'; } ?>><?php echo $text_index_follow; ?></option>
										<option value="noindex, follow" <?php if($articleRobotsValue == 'noindex, follow'){ echo 'selected="selected"'; } ?>><?php echo $text_noindex_follow; ?></option>
										<option value="index, nofollow" <?php if($articleRobotsValue == 'index, nofollow'){ echo 'selected="selected"'; } ?>><?php echo $text_index_nofollow; ?></option>
										<option value="noindex, nofollow" <?php if($articleRobotsValue == 'noindex, nofollow'){ echo 'selected="selected"'; } ?>><?php echo $text_noindex_nofollow; ?></option>
									</select>
									<?php echo $entry_article_robots_help; ?>
								</td>
							</tr>
							<tr>
					...
					<div id="tabComment">
						...
						<table class="form blogSetting">
							...
							<tr>
								<td><?php echo $entry_comment_nofollow_link; ?></td>
								<td class="select_90">
									<select name="commentNofollowLink">
										<?php if ($commentNofollowLinkValue) { ?>
											<option value="1" selected="selected"><?php echo $text_enabled; ?></option>
											<option value="0"><?php echo $text_disabled; ?></option>
										<?php } else { ?>
											<option value="1"><?php echo $text_enabled; ?></option>
									...
									<?php echo $entry_comment_nofollow_link_help; ?>
								</td>
							</tr>
						</table>
