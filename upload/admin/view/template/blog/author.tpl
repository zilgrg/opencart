...
<div id="content">
	...
	<div class="container">
		...
		<?php if (isset($haspermission_addAuthor) || isset($haspermission_editAuthor) || isset($haspermission_removeAuthor) || isset($haspermission_editPermission) || !$adminAvailable) { ?>
            ...
            <a class="button btn-orange btn-help" onclick="window.open('<?php echo $online_help_url;?>', 'online-help', 'resizable=1, width=<?php echo $help_width; ?>, height=<?php echo $help_height; ?>');"><?php echo $text_help; ?></a>
