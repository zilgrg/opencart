								...
								<tr id="comment-row<?php echo $comment['comment_id']; ?>" class="<?php echo $class . $badge . $disabled; ?>">
									...
									<td class="left">
										...
										<div class="blogMeta">
											...
											<?php if ($comment['website']) { echo '<a href="'.$comment['website'].'" target="_blank" title="'.$text_open.'&nbsp;'.$comment['website'].'&nbsp;'.$text_new_window.'">' . $comment['website'] . '</a>'; } ?>
										</div>
									</td>
									<td class="left">
										<div class="blogMeta">
											...
											<?php if ($comment['in_reply']) { echo ' | ' . $text_inreply .'&nbsp;'. $comment['in_reply']; } ?>
										</div>
