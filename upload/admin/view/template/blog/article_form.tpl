         ...
         <div id="tabData" class="vtabs-content">
            <table class="form">
               ...
               <tr>
                  ...
                  <td class="input_120"><input class="datetime" type="text" name="available" value="<?php echo $available; ?>" /></td>
               </tr>
               <tr>
                        ...
                        <tr>
                           <td style="padding:0 0 5px;" colspan="3" class="select_min175">
                              <select id="category" style="margin-bottom: 5px;" onchange="getArticles();">
                                 ...
                                 <option value="non"><?php echo $text_non_cat_art; ?></option>
                                 <?php foreach ($categories as $category) { ?>
                        ...
                        <tr>
                           <td style="padding:0 0 5px;" colspan="3" class="select_min175">
                              <select id="categoryProduct" style="margin-bottom: 5px;" onchange="getProducts();">
                                 <option value="all"><?php echo $text_all_categories; ?></option>
                                 <option value="non"><?php echo $text_non_cat_pr; ?></option>
