   ...
   <div class="container">
      ...
      <div id="et-content">
         <table class="form blogAbout">
            ...
            <tr>
               <td><?php echo $text_changelog; ?></td>
               <td>: <a onclick="window.open('<?php echo $online_help_url;?>', 'online-help', 'resizable=1, width=<?php echo $help_width; ?>, height=<?php echo $help_height; ?>');"><?php echo $text_changelog; ?></a></td>
            </tr>
            <tr>
