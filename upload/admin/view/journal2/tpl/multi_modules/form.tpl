...
<div class="module-header">
    <div class='module-name'>Multi Modules <span data-ng-show="module_id == null">New Module</span><span data-ng-show="module_id != null">Edit Module</span></div>
    ...
    <accordion close-others="module_data.close_others">
        <accordion-group is-open="module_data.general_is_open">
            ...
            <ul class="module-create-options">
                ...
                <li>
                    <span class="module-create-title">Module Spacing</span>
                        <span class="module-create-option">
        ...
        <accordion-group data-ng-repeat="column in module_data.columns" is-open="column.is_open">
            <accordion-heading>
                <div class="accordion-bar bar-level-1"> {{'Item ' + ($index + 1)}} - {{column.width}} % <a href="javascript:;" class="accordion-remove slide-remove" data-ng-click="removeColumn($index)"><b></b>Remove</a></div>
            </accordion-heading>
            <ul class="module-create-options">
                <li>
                    <span class="module-create-title">Width</span>
                    <span class="module-create-option">
            ...
            <accordion close-others="column.close_others">
                <accordion-group data-ng-repeat="module in column.modules" is-open="module.is_open">
                    <accordion-heading>
                        <div class="accordion-bar bar-level-2">Sub Item {{$index + 1}} <a href="javascript:;" class="accordion-remove slide-remove" data-ng-click="removeModule(column, $index)"><b></b>Remove</a></div>
                    </accordion-heading>
                    <ul class="module-create-options">
                        <li>
                            <span class="module-create-title">Module</span>
                            <span class="module-create-option">
                                <select data-ng-model="module.module_id" ui-select2="">
                                    <optgroup data-ng-repeat="(group_key, group) in modules" label="{{group_key}}">
