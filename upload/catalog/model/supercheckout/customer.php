...
//                die;
		...
		$mail->setFrom($this->config->get('config_email'));//changed
		$mail->setSender($this->config->get('config_name'));//changed
		$mail->setSubject(html_entity_decode($subject, ENT_QUOTES, 'UTF-8'));
		$mail->setHtml(html_entity_decode($message, ENT_QUOTES, 'UTF-8'));//changed
		$mail->send();
		
		// Send to main admin email if new account email is enabled
		if ($this->config->get('config_account_mail')) {
			$message  = $this->language->get('text_signup') . "<br/><br/>";
			$message .= $this->language->get('text_website') . ' ' . $this->config->get('config_name') . "<br/>";//changed
			...
			$mail->setTo($this->config->get('config_email'));//changed
