...
class ModelBlogHelper extends Model {
   ...
   public function getGravatar1($email, $width=45, $height=0) {
      ...
      if (isset($this->request->server['HTTPS']) && (($this->request->server['HTTPS'] == 'on') || ($this->request->server['HTTPS'] == '1'))) {
			$url = $this->config->get('config_ssl') . 'image/data/blog_avatar.jpg'; // default image SSL/HTTPS
		} else {
         $url = $this->config->get('config_url') . 'image/data/blog_avatar.jpg'; // default image HTTP
		}
	...
	public function getGravatar($email, $width=45, $height=0) {
		...
		$gravatar .= ' alt="Avatar" width="' . $width . 'px" height="' . $height . 'px" class="avatar" />';
