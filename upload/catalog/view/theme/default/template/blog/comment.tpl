         ...
         <div id="comment-<?php echo $comment['comment_id'];?>" itemprop="comment" itemscope itemtype="http://schema.org/UserComments">
            ...
            <div class="name">
               <?php if($comment['website']) { 
						echo '<a href="'.$comment['website'].'" ';
						if ($comment_nofollow_link){
							echo 'rel="nofollow"';
						}  
						echo '><span itemprop="creator">'.$comment['name'].'</span></a>';
         ...
         <?php if ($comment['replyComments']) { ?>
            ...
            <?php foreach ($comment['replyComments'] as $replyComment) { ?>
               ...
               <li class="<?php echo $class2; ?>">
                  ...
                  <div class="name">
                     <?php if($replyComment['website']) {
							echo '<a href="'.$replyComment['website'].'" ';
							if ($comment_nofollow_link){
								echo 'rel="nofollow"';
							}
							echo '>'.$replyComment['name'].'</a>'; 
						} else { echo $replyComment['name']; }?>
                  </div>
                  <div class="created">
