...
<?php } else { ?>
  <input type="text" style="display:none;" name="firstname" value="<?php echo $firstname; ?>" class="large-field" />
<?php } ?>
...
<?php } else { ?>
  <input type="text" style="display:none;" name="address_1" value="<?php echo $address_1; ?>" class="large-field" />
<?php } ?>
...
<?php } ?>
<?php if ($this->config->get('quickcheckout_telephone')) { ?>
<div class="left">
  <span class="required">*</span> <?php echo $entry_telephone; ?><br />
  <input type="text" name="telephone" value="<?php echo $telephone; ?>" class="large-field" /><br />
</div>
<?php } else { ?>
  <input type="text" style="display:none" name="telephone" value="<?php echo $telephone; ?>" />
<?php } ?>
