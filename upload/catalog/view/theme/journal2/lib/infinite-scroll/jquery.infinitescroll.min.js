...
(function ($) {
    $.fn.infinitescroll = function (options, callback) {
        ...
        function isNearBottom() {
            var pixelsFromWindowBottomToBottom = 0 + getDocumentHeight() - (opts.localMode ? $(props.container).scrollTop() : ($(props.container).scrollTop() || $(props.container.ownerDocument.body).scrollTop())) - $(opts.localMode ? props.container : window).height();
        ...
        function kickOffAjax() {
            ...
            console.log(window.J2FilterData);
            box.load(path.join(props.currPage) + ' ' + opts.itemSelector, window.J2FilterData, loadCallback);
        }
        ...
        props.loadingMsg = $('<span id="infscr-loading" style="text-align: center;"><img alt="Loading..." src="' + opts.loadingImg + '" /><div>' + opts.loadingText + '</div></span>');
