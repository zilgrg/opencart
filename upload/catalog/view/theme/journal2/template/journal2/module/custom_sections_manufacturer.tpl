<div class="box custom-sections section-brand <?php echo $hide_on_mobile_class; ?> <?php echo $single_class; ?> <?php echo $show_title_class; ?>" id="cs-<?php echo $module; ?>" style="<?php echo isset($css) ? $css : ''; ?>">
    <?php if ($show_title): ?>
