<div class="journal-rotator headline-mode box <?php echo $hide_on_mobile_class; ?> bullets-<?php echo $bullets_position; ?> align-<?php echo $text_align; ?> bullets-<?php echo $bullets ? 'on' : 'off'; ?>" id="journal-headline-rotator-<?php echo $module; ?>" style="<?php echo $rotator_css; ?>; <?php echo isset($css) ? $css : ''; ?>">
    ...
    <div class="quote <?php echo $section['cta'] ? 'has-cta' : ''; ?> <?php echo $section['cta'] && $section['cta_position'] ? 'cta-' . $section['cta_position'] : ''; ?>" style="<?php echo $quote_css; ?>">
        ...
        <?php if ($section['cta'] && $section['cta_position'] !== 'left'): ?>
            <?php if ($section['cta_link']): ?>
            <a href="<?php echo $section['cta_link']; ?>" class="cta button button-<?php echo $section['cta_position']; ?>" <?php echo $section['cta_target']; ?> style="<?php echo $section['cta_style']; ?>"><?php echo $section['cta_icon']; ?><?php echo $section['cta_text']; ?></a>
            <?php else: ?>
            <a class="cta" style="<?php echo $section['cta_style']; ?>"><?php echo $section['cta_icon']; ?><?php echo $section['cta_text']; ?></a>
            <?php endif; ?>
        <?php endif; ?>
...
<script>
    (function () {
        ...
        $('#journal-headline-rotator-<?php echo $module; ?>').quovolver({
            children        : '.quote',
            equalHeight     : false,
