<div class="box journal-newsletter <?php echo $hide_on_mobile_class; ?>" id="journal-newsletter-<?php echo $module; ?>" style="<?php echo isset($css) ? $css : ''; ?>">
    ...
    <div class="box-content" style="<?php echo $module_css; ?>">
        ...
        <span class="newsletter-input-wrap" style="<?php echo $input_style; ?>">
            <input type="text" class="newsletter-email" placeholder="<?php echo $input_placeholder; ?>" />
            <a class="newsletter-button button" style="<?php echo $button_style; ?>"><?php echo $button_icon; ?><?php echo $button_text; ?></a>
        </span>
    </div>
    <script>
        $('#journal-newsletter-<?php echo $module; ?> .newsletter-button').click(function () {
