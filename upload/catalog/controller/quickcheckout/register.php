...
class ControllerQuickCheckoutRegister extends Controller {
	...
	public function validate() {
		...
		if (!$json) {
			if ($this->config->get('quickcheckout_firstname')) {
				if ((utf8_strlen($this->request->post['firstname']) < 1) || (utf8_strlen($this->request->post['firstname']) > 32)) {
					$json['error']['firstname'] = $this->language->get('error_firstname');
				}
			}
		
			if ($this->config->get('quickcheckout_lastname')) {
			...
			if ($this->config->get('quickcheckout_telephone')) { 
			...
			if ($this->config->get('quickcheckout_address_1')) { 
				if ((utf8_strlen($this->request->post['address_1']) < 3) || (utf8_strlen($this->request->post['address_1']) > 128)) {
					$json['error']['address_1'] = $this->language->get('error_address_1');
				}
			}
	
			if ($this->config->get('quickcheckout_city')) {
			...
			if ($this->config->get('quickcheckout_zone')) {
